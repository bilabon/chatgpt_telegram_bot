...
# Dmytro, [9 Feb 2023, 15:22:52]:
# ai_aid_bot

# BotFather, [9 Feb 2023, 15:22:52]:
# Done! Congratulations on your new bot. You will find it at t.me/ai_aid_bot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

# Use this token to access the HTTP API:
# 6128315243:AAEcoaoKMuuRNRrvUZxTnsudPDb-BZp-r7E
...
# OpenAI secret Key
API_KEY = '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'
# Models: text-davinci-003,text-curie-001,text-babbage-001,text-ada-001
MODEL = 'text-davinci-003'
# Telegram secret access bot token
BOT_TOKEN = '6128315243:AAEcoaoKMuuRNRrvUZxTnsudPDb-BZp-r7E'
